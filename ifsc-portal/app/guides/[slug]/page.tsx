  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      ...
      <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
        ...
        {/* Sidebar: on-page index + popular calculators */}
        <aside className="space-y-6 lg:sticky lg:top-6 lg:self-start">
          <div className="rounded-2xl border border-ink-200 bg-white p-5 shadow-card">
            <p className="font-display text-base font-bold text-ink-900">On this page</p>
            <ul className="mt-3 space-y-2 border-l border-ink-100 pl-3">
              {content.sections.map((section) => (
                <li key={section.heading}>
                  <Link
                    href={`#${slugifyHeading(section.heading)}`}
                    className="text-sm text-ink-500 hover:text-trust-700"
                  >
                    {section.heading}
                  </Link>
                </li>
              ...
              <li>
                <Link href="#faqs" className="text-sm text-ink-500 hover:text-trust-700">
                  Frequently asked questions
                </Link>
              </li>
            </ul>
